...
exports['test Anim Methods+Properties (not static) without var'] = function() {
  util.assertCompletion("YUI().use('', function(Y) { new Y.Anim().", {
      ...
      "completions":[ {"name":"addAttr","type":"fn(name: string, config: ?, lazy: bool)","origin":"yui3"},
                      {"name":"addAttrs","type":"fn(cfgs: ?, values: ?, lazy: bool)","origin":"yui3"},
                      {"name":"addTarget","type":"fn(o: event_custom.EventTarget)","origin":"yui3"},
                      {"name":"after","type":"fn(type: string, fn: fn(), context?: ?, arg?: ?) -> event_custom.EventHandle","origin":"yui3"},
                      ...
                      {"name":"detach","type":"fn(type: string|Object, fn: fn(), context: ?) -> event_custom.EventTarget","origin":"yui3"},
                      ...
                      {"name":"on","type":"fn(type: string, fn: fn(), context?: ?, arg?: ?) -> event_custom.EventHandle","origin":"yui3"},
                      {"name":"once","type":"fn(type: string, fn: fn(), context?: ?, arg?: ?) -> event_custom.EventHandle","origin":"yui3"},
                      {"name":"onceAfter","type":"fn(type: string, fn: fn(), context?: ?, arg?: ?) -> event_custom.EventHandle","origin":"yui3"},
                      ...
                      {"name":"set","type":"fn(name: string, value: ?, opts: ?)","origin":"yui3"},
                      {"name":"setAttrs","type":"fn(attrs: ?, opts: ?)","origin":"yui3"},
