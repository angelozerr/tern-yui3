...
exports['test Node Methods+Properties static'] = function() {
	util.assertCompletion("YUI().use('', function(Y) { Y.Node.", {
	    ...
	    "isProperty":true,
	    "isObjectKey":false,
	    "completions":[{"name":"addMethod","type":"fn(name: string, fn: fn(), context: ?)","origin":"yui3"},
	                   ...
	                   {"name":"importMethod","type":"fn(host: ?, name: string, altName: string, context: ?)","origin":"yui3"},
...
exports['test Node Methods+Properties (not static) without var'] = function() {
  util.assertCompletion("YUI().use('', function(Y) { new Y.Node().", {
      ...
      "completions":[{"name":"addClass","type":"fn(className: string)","origin":"yui3"},
                     ...
                     {"name":"delegate","type":"fn(type: string, fn: fn(), spec: string, context: ?, args: ?) -> event_custom.EventHandle","origin":"yui3"},
                     ...
                     {"name":"getAttrs","type":"fn(attrs: yui.Array) -> Object","origin":"yui3"},
                     ...
                     {"name":"inRegion","type":"fn(node2: node.Node, all: bool, altRegion: ?) -> bool","origin":"yui3"},
                     ...
                     {"name":"intersect","type":"fn(node2: node.Node, altRegion: ?) -> Object","origin":"yui3"},
                     ...
                     {"name":"on","type":"fn(type: string, fn: fn(e: event.DOMEventFacade), context?: ?, arg?: ?) -> event_custom.EventHandle|fn(type: string, fn: fn(), context?: ?, arg?: ?) -> event_custom.EventHandle","origin":"yui3"},
                     ...
                     {"name":"setAttrs","type":"fn(attrMap: ?)","origin":"yui3"},
                     ...
                     {"name":"setStyles","type":"fn(hash: ?)","origin":"yui3"},
                     ...
                     {"name":"simulate","type":"fn(type: string, options: ?)","origin":"yui3"},
