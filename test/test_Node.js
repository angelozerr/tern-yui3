...
exports['test Node Methods+Properties (not static) without var'] = function() {
  util.assertCompletion("YUI().use('', function(Y) { new Y.Node().", {
      ...
      "completions":[{"name":"addClass","type":"fn(className: string)","origin":"yui3"},
                     ...
                     {"name":"on","type":"fn(type: string, fn: fn(e: event.DOMEventFacade), context?: ?, arg?: ?) -> event_custom.EventHandle|fn(type: string, fn: fn(), context?: yui.Object, arg?: ?) -> event_custom.EventHandle","origin":"yui3"},
                     ...
                     {"name":"select","type":"fn()","origin":"yui3"},{"name":"set","type":"fn(attr: string, val: ?)","origin":"yui3"},
                     ...
                     {"name":"setStyle","type":"fn(attr: string, val: string)","origin":"yui3"},{"name":"setStyles","type":"fn(hash: yui.Object)","origin":"yui3"},
