...
exports['test Node Methods+Properties static'] = function() {
	util.assertCompletion("YUI().use('', function(Y) { Y.Node.", {
	    ...
	    "isProperty":true,
	    "isObjectKey":false,
	    "completions":[{"name":"addMethod","type":"fn(name: string, fn: fn(), context: yui.Object)","origin":"yui3"},
	                   ...
	                   {"name":"importMethod","type":"fn(host: yui.Object, name: string, altName: string, context: yui.Object)","origin":"yui3"},
	                   {"name":"one","type":"fn(node: string) -> node.Node","origin":"yui3"},
	                   {"name":"plug","type":"fn(plugin: fn(), config: ?)","origin":"yui3"},
	                   {"name":"prototype","type":"node.Node.prototype","origin":"yui3"},
	                   {"name":"scrubVal","type":"fn(node: Element) -> node.Node","origin":"yui3"},
	                   {"name":"unplug","type":"fn(plugin: fn())","origin":"yui3"},
	                   {"name":"ATTRS","type":"?","origin":"yui3"},
...
exports['test Node Methods+Properties (not static) without var'] = function() {
  util.assertCompletion("YUI().use('', function(Y) { new Y.Node().", {
      ...
      "completions":[{"name":"addClass","type":"fn(className: string)","origin":"yui3"},
                     ...
                     {"name":"append","type":"fn(content: string)","origin":"yui3"},
                     {"name":"appendChild","type":"fn(node: string) -> node.Node","origin":"yui3"},
                     {"name":"appendTo","type":"fn(node: node.Node)","origin":"yui3"},
                     ...
                     {"name":"delegate","type":"fn(type: string, fn: fn(), spec: string, context: yui.Object, args: ?) -> event_custom.EventHandle","origin":"yui3"},
                     ...
                     {"name":"getAttrs","type":"fn(attrs: yui.Array) -> yui.Object","origin":"yui3"},
                     {"name":"getComputedStyle","type":"fn(attr: string) -> string","origin":"yui3"},
                     {"name":"getDOMNode","type":"fn() -> Element","origin":"yui3"},
                     {"name":"getData","type":"fn(name: string)","origin":"yui3"},
                     ...
                     {"name":"getXY","type":"fn() -> yui.Array","origin":"yui3"},
                     {"name":"getY","type":"fn() -> number","origin":"yui3"},
                     {"name":"hasAttribute","type":"fn(attribute: string) -> bool","origin":"yui3"},
                     {"name":"hasChildNodes","type":"fn() -> bool","origin":"yui3"},{"name":"hasClass","type":"fn(className: string) -> bool","origin":"yui3"},
                     {"name":"hide","type":"fn(name: string, config: ?, callback: fn())","origin":"yui3"},
                     {"name":"inDoc","type":"fn(doc: node.Node) -> bool","origin":"yui3"},
                     {"name":"inRegion","type":"fn(node2: node.Node, all: bool, altRegion: yui.Object) -> bool","origin":"yui3"},
                     {"name":"insert","type":"fn(content: string, where: number)","origin":"yui3"},
                     {"name":"insertBefore","type":"fn(newNode: string, refNode: Element) -> node.Node","origin":"yui3"},
                     {"name":"intersect","type":"fn(node2: node.Node, altRegion: yui.Object) -> yui.Object","origin":"yui3"},
                     ...
                     {"name":"on","type":"fn(type: string, fn: fn(e: event.DOMEventFacade), context?: ?, arg?: ?) -> event_custom.EventHandle","origin":"yui3"},
                     {"name":"one","type":"fn(selector: string) -> node.Node","origin":"yui3"},
                     {"name":"prepend","type":"fn(content: string)","origin":"yui3"},
                     ...
                     {"name":"replaceChild","type":"fn(node: string, refNode: Element) -> node.Node","origin":"yui3"},
                     {"name":"replaceClass","type":"fn(oldClassName: string, newClassName: string)","origin":"yui3"},
                     {"name":"reset","type":"fn()","origin":"yui3"},{"name":"scrollIntoView","type":"fn()","origin":"yui3"},
                     ...
                     {"name":"setAttrs","type":"fn(attrMap: yui.Object)","origin":"yui3"},
                     {"name":"setData","type":"fn(name: string, val: ?)","origin":"yui3"},
                     {"name":"setHTML","type":"fn(content: string)","origin":"yui3"},
                     {"name":"setStyle","type":"fn(attr: string, val: string)","origin":"yui3"},
                     {"name":"setStyles","type":"fn(hash: yui.Object)","origin":"yui3"},
                     {"name":"setX","type":"fn(x: number)","origin":"yui3"},
                     {"name":"setXY","type":"fn(xy: yui.Array)","origin":"yui3"},
                     ...
                     {"name":"simulate","type":"fn(type: string, options: yui.Object)","origin":"yui3"},
                     {"name":"simulateGesture","type":"fn(name: string, options?: yui.Object, cb?: fn(err: Error))","origin":"yui3"},
                     ...
                     {"name":"text","type":"string","origin":"yui3"},{"name":"toString","type":"fn() -> string","origin":"yui3"},
